...
FIRESMOKE_DIR = Path(__file__).resolve().parent
TEST_IMAGES_DIR = FIRESMOKE_DIR / "imgs"
OUTPUTS_DIR = FIRESMOKE_DIR / "outputs"
MODELS_DIR = FIRESMOKE_DIR
YOLO_CONFIG_DIR = FIRESMOKE_DIR / ".ultralytics"
...
FEATURE_NAME = "fireSmoke"
DISPLAY_NAME = "火灾烟雾识别模型"
EXPECTED_LABELS = ("Fire", "smoke")
DEFAULT_MODEL_PATH = FIRESMOKE_DIR / "best.pt"
DEFAULT_MODEL_NAME = str(DEFAULT_MODEL_PATH)
DEFAULT_IMAGE_PATH = TEST_IMAGES_DIR / "fire.png"
DEFAULT_CONF = 0.25
DEFAULT_IOU = 0.45
...
FEATURE_CONFIG = FireSmokeConfig()
...
class FireSmokeDetector:
    ...
    def run_camera_inference(
        ...
        window_name: str = "Fire and Smoke Detection",
        width: int = 1280,
        height: int = 720,
        framerate: int = 30,
        flip_method: int = 0,
            ...
            while True:
                ...
                if frame_log_interval > 0 and frame_count % frame_log_interval == 0:
                    if prediction.detections:
                        ...
                        print("[DETECT] No fire or smoke related objects in this frame.")
