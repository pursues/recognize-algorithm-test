...
from smoking import DEFAULT_IMAGE_PATH
from smoking import DEFAULT_MODEL_PATH
from smoking import FEATURE_CONFIG
from smoking import OUTPUTS_DIR
from smoking import SmokingDetector


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="测试 smoking 目录下的抽烟识别模型。")
    ...
    parser.add_argument("--window-name", default="Smoking Detection", help="实时识别窗口标题")
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=OUTPUTS_DIR,
...
def main() -> None:
    ...
    result = {
        ...
        "smoking_detections": [
            ...
            for detection in smoking_detections
        ],
        "detected": bool(smoking_detections),
