...
SMOKING_DIR = Path(__file__).resolve().parent
TEST_IMAGES_DIR = SMOKING_DIR / "imgs"
OUTPUTS_DIR = SMOKING_DIR / "outputs"
MODELS_DIR = SMOKING_DIR
YOLO_CONFIG_DIR = SMOKING_DIR / ".ultralytics"
...
DISPLAY_NAME = "抽烟/香烟识别模型"
EXPECTED_LABELS = ("cigarette", "smoking")
DEFAULT_HF_MODEL_NAME = "Amin-moniry-pr7/Smoking_Detection.pt"
DEFAULT_MODEL_PATH = SMOKING_DIR / "best.pt"
DEFAULT_MODEL_NAME = str(DEFAULT_MODEL_PATH)
DEFAULT_IMAGE_PATH = TEST_IMAGES_DIR / "smoking.jpeg"
DEFAULT_CONF = 0.25
DEFAULT_IOU = 0.45
...
class SmokingDetector:
    ...
    def run_camera_inference(
        ...
        window_name: str = "Smoking Detection",
        width: int = 1280,
        height: int = 720,
        framerate: int = 30,
        flip_method: int = 0,
            ...
            while True:
                ...
                if frame_log_interval > 0 and frame_count % frame_log_interval == 0:
                    if prediction.detections:
                        ...
                        print("[DETECT] No smoking-related objects in this frame.")
